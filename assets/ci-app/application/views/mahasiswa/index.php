<div class="container">
    ...
    <?php if ($this->session->flashdata('flash')) : unset($_SESSION['flash']);?>
    <!-- <div class="row mt-3">
        <div class="col-md-6">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <a href="<?= base_url(); ?>mahasiswa/hapus/<?= $mhs['id']; ?>"
                        class="btn btn-danger btn-sm float-right tombol-hapus">Delete</a>
                    <a href="<?= base_url(); ?>mahasiswa/ubah/<?= $mhs['id']; ?>"
                        class="btn btn-success btn-sm float-right mr-2">Edit</a>
